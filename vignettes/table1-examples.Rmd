...
Finally, we can customize the contents using custom renderers. Custom renders can be functions that take a vector as the first argument and return a character vector.
