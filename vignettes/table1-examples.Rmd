...
`results="asis"` chunk option to pass the HTML output through untouched. The
package does allow quite a bit of flexibility to customize the table's contents
and appearance, but this does come at the cost of ease-of-use (more
programming, some knowledge of CSS).
